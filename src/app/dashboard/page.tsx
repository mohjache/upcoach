...
const Page = () => {
  return (
    <>
      ...
      <AuthLoading>
        <div className="grid grid-cols-1 gap-4 px-8 pb-4 lg:grid-cols-2 xl:grid-cols-3">
      ...
      <Authenticated>
        <div className="grid grid-cols-1 gap-4 px-8 pb-8 lg:grid-cols-2 xl:grid-cols-3">
